        ...
        <div className=" flex w-[100%] flex-col justify-center items-center ">
            <div className=" w-[100%] flex items-center justify-center my-5 px-6 ">
                <div className=" overflow-visible  relative flex   w-[95%] rounded-xl items-center justify-center ozel:flex-col ozel:w-[88%]  ">
                    ...
                    <div className="flex flex-col flex-1 pl-[50px] gap-4 ozel:items-center ozel:text-center">
                        ...
                        <button className=" hover:bg-[#4faee5] hover:scale-[.9] bg-[#23A6F0] font-extrabold rounded-lg py-3  text-md w-[30%] ozel:w-[50%] text-white   ">Get Quote Now </button>
                    </div>
            ...
            <div className=" flex gap-3 w-[82%] my-24 ozel:flex-col ">
                <div className=" flex flex-col flex-1 gap-4 ozel:items-center ozel:text-center">
                ...
                <div className=" flex items-center flex-1 ozel:items-center ozel:text-center ozel:w-[98%] ">
            ...
            <div className=" flex w-[75%] my-10 ozel:flex-col ">
            ...
            <div className=" flex w-[100%] flex-col bg-[#FAFAFA] items-center justify-center pt-20">
                <div className=" flex flex-col gap-3 items-center justify-center w-[80%] ozel:text-center ">
            ...
            <div className="w-[100%] flex ">
                <div className="w-[60%] flex items-center justify-center bg-[#2A7CC7] ozel:w-[100%] ozel:py-10">
                ...
                <div className="w-[40%] ozel:hidden">
