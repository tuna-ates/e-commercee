    ...
    return (
        ...
        <div className=" flex gap-16 w-[80%]">
         ...
         <div className=" flex flex-1 flex-col gap-4 justify-center">
            ...
            <p className=" font-black text-[#252B42] text-[40px]">{featuredData.title2}</p>
            <p className="text-[#737373] w-[70%]">{featuredData.about1}</p>
            <p className="text-[#737373] w-[70%]">{featuredData.about2}</p>
