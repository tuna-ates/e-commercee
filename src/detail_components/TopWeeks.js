...
const TopWeeks = () => {
    ...
    return (
        <div className="w-[100%] flex items-center justify-center h-[70vh] ozel:h-[90vh] " >
            <div className=" flex gap-3 w-[80%] h-[100%] ozel:flex-col  ">
                ...
                <div className="flex-1 flex flex-col gap-3 ozel:h-[100%] ">
